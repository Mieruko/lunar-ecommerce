...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $records = [
            ['brand' => $seiko, 'category' => $dress, 'name' => 'Seiko Presage Cocktail Time SRPB43', 'slug' => 'seiko-presage-cocktail-time-srpb43', 'type' => 'watch', 'sku' => 'SEI-SRPB43', 'variant' => 'Mặt xanh / Dây thép', 'price' => 11250000, 'image' => 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?auto=format&fit=crop&w=1200&q=85', 'detail' => ['movement' => 'Automatic with manual winding', 'caliber' => '4R35', 'case_material' => 'Thép không gỉ', 'case_diameter_mm' => 40.5, 'case_thickness_mm' => 11.8, 'dial_color' => 'Xanh navy', 'water_resistance_m' => 50, 'crystal' => 'Hardlex', 'strap_material' => 'Thép không gỉ', 'power_reserve_hours' => 41, 'functions' => ['Hiển thị ngày', 'Dừng kim giây'], 'warranty_months' => 24]],
